...
public class FeaturedAdapter extends RecyclerView.Adapter<FeaturedAdapter.FeaturedViewHolder> {
    ...
    static class FeaturedViewHolder extends RecyclerView.ViewHolder {
        ...
        public FeaturedViewHolder(@NonNull View itemView) {
            ...
            titleText = itemView.findViewById(R.id.featuredTitle);
            metaText = itemView.findViewById(R.id.featuredMeta);
            summaryText = itemView.findViewById(R.id.featuredSummary);
            bookmarkButton = itemView.findViewById(R.id.featuredBookmarkButton);
        }
    }
}
